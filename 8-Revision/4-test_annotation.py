# for Jaderberg synthetic dataset, this is an annotation creation file
# for test dataset in 3000 folder
...
print()
i = 1
with open(os.path.join('/home/varsha/Desktop/AnuPriya', 'annotation_test.txt'), 'w') as f:
